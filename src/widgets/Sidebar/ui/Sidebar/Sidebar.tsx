...
interface SidebarProprs {
    className?: string;
}

export const Sidebar = ({ className }: SidebarProprs) => {
    ...
    return (
        <div data-testid="sidebar" className={classNames(cls.Sidebar, { [cls.collapsed]: collapsed }, [className])}>
            <Button data-testid="sidebar-toggle" className={cls.collapseBtn} theme={ButtonTheme.BACKGROUND_INVERTED} size={ButtonSize.L} square onClick={onToggle}>
                {collapsed ? '>' : '<'}
            </Button>
